...
export var Input = memo(function (props) {
    ...
    var onSelect = function (e) {
        var _a;
        setCaretPosition((_a = e === null || e === void 0 ? void 0 : e.target) === null || _a === void 0 ? void 0 : _a.selectionStart);
    };
    return (_jsxs("div", __assign({ className: classNames(cls.InputWrapper, {}, [className]) }, { children: [placeholder && (_jsx("div", __assign({ className: cls.placeholder }, { children: "".concat(placeholder, " >") }), void 0)), _jsxs("div", __assign({ className: cls.caretWrapper }, { children: [_jsx("input", __assign({ ref: ref, type: type, value: value, onChange: onChangeHandler, className: cls.input, onFocus: onFocus, onBlur: onBlur, onSelect: onSelect }, otherProps), void 0), isFocused && (_jsx("span", { className: cls.caret, style: { left: "".concat(caretPosition * 9, "px") } }, void 0))] }), void 0)] }), void 0));
});
